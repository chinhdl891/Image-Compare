...
class ImageCompareSlider @JvmOverloads constructor(
    ...
    private fun bitmapToDrawable(context: Context, bitmap: Bitmap): Drawable {
        return BitmapDrawable(context.resources, bitmap)
    }

    fun setUpSlideCompare(bitmapBackGround: Bitmap, bitmapForeground: Bitmap) {
        binding.backgroundImage.setImageBitmap(bitmapBackGround)
        binding.foregroundImage.setImageBitmap(bitmapForeground)
        invalidate()
    }
